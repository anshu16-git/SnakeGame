...
cover = cover.convert()
cover.fill((0, 0, 0))
window.blit(cover, (50,50))

# Refreshing the screen to display everything
pygame.display.flip()

# Loading the main images on the game window
head = pygame.image.load(r"C:\Users\Abhi\AppData\Local\Temp\snake_game.py\head.png").convert_alpha()
head = pygame.transform.scale(head, (35,35))

body_part_1 = pygame.image.load(r"C:\Users\Abhi\AppData\Local\Temp\snake_game.py\body.png").convert_alpha()
body_part_1 = pygame.transform.scale(body_part_1, (25,25))

fruit = pygame.image.load(r"C:\Users\Abhi\AppData\Local\Temp\snake_game.py\fruit.png").convert_alpha()
